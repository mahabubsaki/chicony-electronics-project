            ...
            <div className="modal modal-middle">
                <div className="modal-box">
                    ...
                    <form onSubmit={handleUpdateForm}>
                        <input type="text" name="name" className="w-full rounded-lg border border-[#CFCFCF] p-2 my-3" placeholder="Enter Your Name" defaultValue={name && name} required />
                        <input type="text" name="education" className="w-full rounded-lg border border-[#CFCFCF] p-2 my-3" placeholder="Enter Your Education" defaultValue={education && education} required />
                        <input type="text" name="location" className="w-full rounded-lg border border-[#CFCFCF] p-2 my-3" placeholder="Enter Your Location" defaultValue={location && location} required />
                        <input type="text" name="phone" className="w-full rounded-lg border border-[#CFCFCF] p-2 my-3" placeholder="Enter Your Contact Number" defaultValue={phone && phone} required />
                        <input type="text" name="linkedin" className="w-full rounded-lg border border-[#CFCFCF] p-2 my-3" placeholder="Enter Your LinkdIn profile link" defaultValue={linkedin && linkedin} required />
                    ...
                    {(updating || loading || saving) && <div className="flex justify-center mt-3">
